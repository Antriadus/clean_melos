...
class _$UsersStateTearOff {
  ...
  UsersStateError error() {
    return const UsersStateError();
  }
}
...
/// @nodoc
abstract class $UsersStateErrorCopyWith<$Res> {
  factory $UsersStateErrorCopyWith(
          UsersStateError value, $Res Function(UsersStateError) then) =
      _$UsersStateErrorCopyWithImpl<$Res>;
}

/// @nodoc
class _$UsersStateErrorCopyWithImpl<$Res> extends _$UsersStateCopyWithImpl<$Res>
    implements $UsersStateErrorCopyWith<$Res> {
  _$UsersStateErrorCopyWithImpl(
      UsersStateError _value, $Res Function(UsersStateError) _then)
      : super(_value, (v) => _then(v as UsersStateError));

  @override
  UsersStateError get _value => super._value as UsersStateError;
}

/// @nodoc

class _$UsersStateError implements UsersStateError {
  const _$UsersStateError();
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is UsersStateError);
  }
...
abstract class UsersStateError implements UsersState {
  const factory UsersStateError() = _$UsersStateError;
}
